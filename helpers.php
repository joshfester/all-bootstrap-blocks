...
function areoi_get_prepend_content( $attributes )
{
	...
	if ( !empty( $attributes['prepend_display_heading'] ) || !empty( $attributes['prepend_display_intro'] ) ) {
		...
		$prepend_heading = !empty( $attributes['prepend_display_heading'] ) && !empty( $attributes['prepend_heading'] ) ? '<' . $heading_level . ' class="' . $heading_color . '">' . wp_kses_post( $attributes['prepend_heading'] ) . '</' . $heading_level . '>' : '';
		$prepend_intro = !empty( $attributes['prepend_intro'] ) && !empty( $attributes['prepend_intro'] ) ? '<p class="' . $intro_color . '">' . wp_kses_post( $attributes['prepend_intro'] ) . '</p>' : '';
